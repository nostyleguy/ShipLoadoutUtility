...
namespace CompLib
{
    ...
    /// </summary>
    [Serializable()]
    public class Capacitor : DataTable
    {
        #region Constructor
        ...
        public void AddCapacitor(string name, double armor, double mass, double drain, double energy, double recharge)
        {
            try
            {
        ...
        public void RemoveCapacitor(string name)
        {
            try
            {
