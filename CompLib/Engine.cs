...
namespace CompLib
{
    ...
    public class Engine : DataTable
    {
        ...
        public Engine()
        {
            ...
            this.Columns.Add("Pitch", Type.GetType("System.Double"));
            this.Columns.Add("Yaw", Type.GetType("System.Double"));
            this.Columns.Add("Roll", Type.GetType("System.Double"));
        ...
        public void AddEngine(string name, double armor, double mass, double drain, double pitch, double yaw,
            double roll, double speed)
        {
            try
            {
