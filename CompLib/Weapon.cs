...
namespace CompLib
{
    ...
    public class Weapon : DataTable
    {
        ...
        public Weapon()
        {
            ...
            this.Columns.Add("EPS", Type.GetType("System.Double"));
            this.Columns.Add("Refire", Type.GetType("System.Double"));
        ...
        public void AddWeapon(string name, double armor, double mass, double drain, double minD, double maxD,
            double vsS, double vsA, double eps, double refire)
        {
            try
            {
