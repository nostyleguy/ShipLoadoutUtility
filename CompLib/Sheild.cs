...
namespace CompLib
{
    ...
    public class Sheild : DataTable
    {
        ...
        public Sheild()
        {
            ...
            this.Columns.Add("Front HP", Type.GetType("System.Double"));
            this.Columns.Add("Back HP", Type.GetType("System.Double"));
            this.Columns.Add("Recharge", Type.GetType("System.Double"));
            this.Columns.Add("Adjustment", Type.GetType("System.Int32"));
        ...
        public void AddSheild(string name, double armor, double mass, double drain, double frontHP, double backHP,
            double recharge, Int32 adjustment)
        {
            try
            {
        ...
        public void RemoveSheild(string name)
        {
            try
            {
