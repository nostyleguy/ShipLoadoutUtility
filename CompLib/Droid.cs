...
namespace CompLib
{
    ...
    public class Droid : DataTable
    {
        ...
        public Droid()
        {
            ...
            this.Columns.Add("Command Speed", Type.GetType("System.Double"));
        ...
        public void AddDroid(string name, double armor, double mass, double drain, double speed)
        {
            try
            {
